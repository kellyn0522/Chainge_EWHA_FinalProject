...
const {createReq, findUserSendReq, findUserReceivedReq, findReq, acceptReq, deleteReq, doTenantSign, doLandlordSign, setReqContract, getRequsetByItem, findSpecificReq} = require("../Controllers/reqController");
...
router.get("/findSpecificReq/:ownerID/:itemID/:senderID", findSpecificReq);
